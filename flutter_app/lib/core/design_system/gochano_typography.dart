...
class GochanoTypography {
  ...
  /// Fallback families for consistent Bengali and Latin typography rendering.
  ...
  TextStyle get cardHeading =>
      _base.copyWith(fontSize: 15, height: 1.40, fontWeight: FontWeight.w600);

  /// Default reading text.
  TextStyle get body =>
      _base.copyWith(fontSize: 14.5, height: 1.50, fontWeight: FontWeight.w400);
