...
if (releaseRequested && !keystorePropertiesFile.exists()) {
    throw GradleException(
        ...
        "using android/key.properties.example before building a release."
    )
}

android {
    namespace = "com.ekthikana.ekthikana"
    compileSdk = 36
    ...
    defaultConfig {
        // Keep this ID for compatibility with the existing Firebase project.
        applicationId = "com.ekthikana.ekthikana"
        minSdk = 24
