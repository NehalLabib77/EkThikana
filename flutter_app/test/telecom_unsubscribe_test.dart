...
void main() {
  ...
  group('TelecomAuthService.normalize and isSupportedPhone', () {
    ...
    test('validates supported carriers: Robi (018) and Cirkle (016)', () {
      ...
      expect(
        TelecomAuthService.isSupportedPhone('01512345678'),
        isFalse,
      ); // Teletalk
  ...
  group('TelecomAuthService unsubscribe validation', () {
    test(
      'throws TelecomAuthException for unsupported carrier number',
      () async {
        expect(
  ...
  group('TelecomAuthService session lifecycle', () {
    ...
    test(
      'persistSession sets authoritative keys and clears legacy keys',
      () async {
